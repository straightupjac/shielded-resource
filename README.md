...
* **Evaluate**: This is an ethical design step that asks us to consider who might negatively be impacted by the creation of our tool, and how we might mitigate that harm. we discovered the theory of sensible privacy, which asks us to consider how to implement 
